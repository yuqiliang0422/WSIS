...
#############################COCO#################################
# /mass/wsk/dataset/VOCdevkit/VOC2012/JPEGImages/
# /mass/wsk/dataset/VOCdevkit/VOC2012/annotations/voc_2012_trainaug.json
# /mass/wsk/dataset/VOCdevkit/VOC2012/annotations/voc_2012_val.json
# /mass/lyq/lyq/PycharmProjects/prm_cam/vision_transformer/new_json.json
# /mass/wsk/dataset/coco2014/train2017/
# /mass/wsk/dataset/coco2014/val2017/
# /mass/wsk/dataset/coco2014/annotations/instances_train2017.json
# /mass/wsk/dataset/coco2014/annotations/instances_val2017.json
class COCO_Classification(Dataset):   ## Dataset for COCO classification.        read the dataset, complete the annotation initialization
    ...
    def __init__(self, data_dir="/mass/wsk/dataset/VOCdevkit/VOC2012/JPEGImages/",
                 annFile = "/mass/wsk/dataset/VOCdevkit/VOC2012/annotations/voc_2012_trainaug.json" ,
...
class COCO_VAL_Classification(
    Dataset):  ## Dataset for COCO classification.        read the dataset, complete the annotation initialization

    def __init__(self, data_dir="/mass/wsk/dataset/VOCdevkit/VOC2012/JPEGImages/",
                 annFile="/mass/wsk/dataset/VOCdevkit/VOC2012/annotations/voc_2012_val.json",
                 classes=coco_object_categories(),
                 transform=None, target_transform=None):
        self.data_dir = data_dir
        self.coco = COCO(annFile)
